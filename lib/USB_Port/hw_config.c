...
void USB_Interrupts_Config(void)
{
  ...
  NVIC_Init(&NVIC_InitStructure);
#endif /* STM32L1XX_XD */
// Redifei: UNUSED UART NVIC Setting
#if 0
...
{
// Redifei: DELETE UART Config Default Function
#if 0
...
{
// Redifei: DELETE UART Config Function
#if 0
  /* set the Stop bit*/
...
// Redifei: ADD USB Send Data
void USB_Send_Data(uint8_t data) {
  //-- 전송 버퍼가 꽉 차면 기다린다
//  while (1) {
//    if ((USART_Rx_length + 1) < USART_RX_DATA_SIZE)
//      break;
//  }
...
{
// Redifei: UNUSED USART Send Data
#if 0
  uint32_t i;
...
#else
  USB_Receive_Data(data_buffer, Nb_bytes);
#endif
}
...
{
// Redifei: UNUSED USART To USB Send Data
#if 0
